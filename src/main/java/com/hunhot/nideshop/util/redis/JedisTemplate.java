package com.hunhot.nideshop.util.redis;
...
public class JedisTemplate {
    ...
    /**
     * The command is exactly equivalent to the following group of commands: {@link #set(String, String) SET} {@link #expire(String, int) EXPIRE}.
